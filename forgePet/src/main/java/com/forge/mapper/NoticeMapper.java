...
public interface NoticeMapper extends BaseMapper<Notice> {
    ...
    List<NoticeDto> selectNoticePage(@Param("noticeName") String noticeName, @Param("begin") int begin, @Param("pageItem") int pageItem);

    List<NoticeDto> selectFour();

    boolean updateNotice(@Param("username") String username, @Param("noticeTitle") String noticeTitle, @Param("noticeId") long noticeId);

    boolean addNotice(@Param("username") String username, @Param("noticeTitle") String noticeTitle, @Param("noticeFile") String noticeFile);
