...
public class MyServer implements HttpHandler {
    private static final String REQ_CONTEXT = "/operateFile";
    private static final String REQ_FOLDER = "./src/main/resources";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("测试访问:http://localhost:9527" + REQ_CONTEXT + "/testResize.jpg");
        System.out.println("测试访问:http://localhost:9527" + REQ_CONTEXT + "/index.html?testResize");
    }
    ...
    public void handle(HttpExchange httpExchange) {
        try {
            ...
            // 从java的执行路径开始算
            String path = REQ_FOLDER + httpExchange.getRequestURI().getPath();
    ...
    private String getImgFileList() {
        // 指定要读取的文件夹路径
        File folder = new File(REQ_FOLDER + REQ_CONTEXT);
